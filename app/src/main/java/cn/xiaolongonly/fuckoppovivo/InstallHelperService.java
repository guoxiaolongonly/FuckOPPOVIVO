package cn.xiaolongonly.fuckoppovivo;
...
public class InstallHelperService extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if ("com.coloros.safecenter".equals(event.getPackageName()) || "com.vivo.secime.service".equals(event.getPackageName())) {
    ...
    private void fillPassword(AccessibilityNodeInfo rootNode, String password) {
        ...
        if (editText != null && editText.getClassName().equals("android.widget.EditText")) {
        ...
        List<AccessibilityNodeInfo> nodeInfoList = rootNode.findAccessibilityNodeInfosByText("安装");
        nodeInfoList.addAll(rootNode.findAccessibilityNodeInfosByText("确定"));
        nodeInfoList.addAll(rootNode.findAccessibilityNodeInfosByText("重新安装"));
